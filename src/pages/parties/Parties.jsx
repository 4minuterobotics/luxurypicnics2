	...
	return (
		<PageAnimation1>
			<div className='add-margin-regular-page'>
				<PageTitle text='Party Styles' titleSize='long-title' />
				<Container>
					{/* Stack the columns on mobile by making one full-width and the other half-width */}
					<Row>
						<Col xs={12} md={6}>
							<SlideShow slideShowData={luxuryParties.setupOne.slideImages} />
						</Col>
						<Col xs={12} md={6}>
							<BundleSummary
				...
				<Container>
					...
					<Row>
						<Col xs={12} md={6}>
							<SlideShow slideShowData={luxuryParties.setupTwo.slideImages} />
						</Col>
						<Col xs={12} md={6}>
							<BundleSummary
